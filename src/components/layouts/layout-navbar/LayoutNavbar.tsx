      ...
      <Navbar.Collapse>
        ...
        <Nav className="align-items-lg-center ml-auto">
          <Dropdown as={Nav.Item} className="demo-navbar-notifications mr-lg-3" alignRight={!isRTL}>
            ...
            <Dropdown.Menu>
              <div className="bg-primary text-center text-white font-weight-bold p-3">4 New Notifications</div>
              <ListGroup variant="flush">
                <ListGroup.Item as={Media} action className="d-flex align-items-center">
                  ...
                  <Media.Body className="line-height-condenced ml-3">
                    ...
                    <div className="text-light small mt-1">Aliquam ex eros, imperdiet vulputate hendrerit et.</div>
                ...
                <ListGroup.Item as={Media} action className="d-flex align-items-center">
                  ...
                  <Media.Body className="line-height-condenced ml-3">
                    ...
                    <div className="text-light small mt-1">Phasellus nunc nisl, posuere cursus pretium nec, dictum vehicula tellus.</div>
                  </Media.Body>
                </ListGroup.Item>
                ...
                <ListGroup.Item as={Media} action className="d-flex align-items-center">
                  ...
                  <Media.Body className="line-height-condenced ml-3">
                    ...
                    <div className="text-light small mt-1">Etiam nec fringilla magna. Donec mi metus.</div>
                    <div className="text-light small mt-1">20h ago</div>
                  </Media.Body>
                </ListGroup.Item>
              </ListGroup>

              <a href="#link" className="d-block text-center text-light small p-2 my-1" onClick={(e) => e.preventDefault()}>
          ...
          <Dropdown as={Nav.Item} className="demo-navbar-messages mr-lg-3" alignRight={!isRTL}>
            ...
            <Dropdown.Menu>
              <div className="bg-primary text-center text-white font-weight-bold p-3">4 New Messages</div>
              <ListGroup variant="flush">
                <ListGroup.Item as={Media} action className="d-flex align-items-center">
                  <img
                    src={`${process.env.PUBLIC_URL}/img/avatars/6-small.png`}
                    className="d-block flex-shrink-0 ui-w-40 rounded-circle"
                    alt="User"
                  />
                  <Media.Body className="line-height-condenced ml-3">
                    <div className="text-body line-height-condenced">Sit meis deleniti eu, pri vidit meliore docendi ut.</div>
                    <div className="text-light small mt-1">Mae Gibson &nbsp;·&nbsp; 58m ago</div>
                  </Media.Body>
                </ListGroup.Item>

                <ListGroup.Item as={Media} action className="d-flex align-items-center">
                  <img
                    src={`${process.env.PUBLIC_URL}/img/avatars/4-small.png`}
                    className="d-block flex-shrink-0 ui-w-40 rounded-circle"
                    alt="User"
                  />
                  <Media.Body className="line-height-condenced ml-3">
                    <div className="text-body line-height-condenced">Mea et legere fuisset, ius amet purto luptatum te.</div>
                    <div className="text-light small mt-1">Kenneth Frazier &nbsp;·&nbsp; 1h ago</div>
                  </Media.Body>
                </ListGroup.Item>

                <ListGroup.Item as={Media} action className="d-flex align-items-center">
                  <img
                    src={`${process.env.PUBLIC_URL}/img/avatars/5-small.png`}
                    className="d-block flex-shrink-0 ui-w-40 rounded-circle"
                    alt="User"
                  />
                  <Media.Body className="line-height-condenced ml-3">
                    <div className="text-body line-height-condenced">Sit meis deleniti eu, pri vidit meliore docendi ut.</div>
                    <div className="text-light small mt-1">Nelle Maxwell &nbsp;·&nbsp; 2h ago</div>
                  </Media.Body>
                </ListGroup.Item>

                <ListGroup.Item as={Media} action className="d-flex align-items-center">
                  <img
                    src={`${process.env.PUBLIC_URL}/img/avatars/11-small.png`}
                    className="d-block flex-shrink-0 ui-w-40 rounded-circle"
                    alt="User"
                  />
                  <Media.Body className="line-height-condenced ml-3">
                    <div className="text-body line-height-condenced">Lorem ipsum dolor sit amet, vis erat denique in, dicunt prodesset te vix.</div>
                    <div className="text-light small mt-1">Belle Ross &nbsp;·&nbsp; 5h ago</div>
                  </Media.Body>
                </ListGroup.Item>
              </ListGroup>
          ...
          <Dropdown as={Nav.Item} className="demo-navbar-user" alignRight={!isRTL}>
            ...
            <Dropdown.Menu>
              <Dropdown.Item hred="#">
                <i className="ion ion-ios-person text-lightest"></i> &nbsp; My profile
              </Dropdown.Item>
              <Dropdown.Item hred="#">
                <i className="ion ion-ios-mail text-lightest"></i> &nbsp; Messages
              </Dropdown.Item>
              <Dropdown.Item hred="#">
                <i className="ion ion-md-settings text-lightest"></i> &nbsp; Account settings
              </Dropdown.Item>
              <Dropdown.Divider />
              <Dropdown.Item hred="#">
                <i className="ion ion-ios-log-out text-danger"></i> &nbsp; Log Out
              </Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
        </Nav>
